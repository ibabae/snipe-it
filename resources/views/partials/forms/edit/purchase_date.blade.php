...
<div class="form-group {{ $errors->has('purchase_date') ? ' has-error' : '' }}">
   ...
   <div class="input-group col-md-4">
        <div class="input-group @if(in_array(app()->getLocale(),['ar-SA','fa-IR', 'he-IL'])) pdate @else date @endif" data-provide="datepicker" data-date-clear-btn="true" data-date-format="yyyy-mm-dd"  data-autoclose="true">
